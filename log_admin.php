...
<html>
	...
	<body class="log_body">
		<main class="main">
			...
			<form method="post" class="log_form" action="check_admin.php">
				<center>
					...
					<input type="submit" class="btn btn-primary btn-block mb-4" value="Увійти до панелі адміна" /><br>
				</center>
			</form>
		</main>
